...
class FlutterArCoreMaterial(map: HashMap<String, *>) {
    ...
    var metallic: Int = map["metallic"] as? Int ?: DEFAULT_METALLIC

    @field:IntRange(from = 0, to = 100)
    var roughness: Int = map["roughness"] as? Int ?: DEFAULT_ROUGHNESS

    @field:IntRange(from = 0, to = 100)
    var reflectance: Int = map["reflectance"] as? Int ?: DEFAULT_REFLECTANCE
